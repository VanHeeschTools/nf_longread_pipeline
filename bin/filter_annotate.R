...
# Track versions:
version <- "1.1" #Removed refSeq flags for improved compatibility
date <- "26-02-2025"
...
filterGTF <- function(gtf_ref_path, min_occurrence, min_tpm,novel_gtf_path, tracking_file, output_prefix) {
